...
class JSXComponentNode extends JSXNode {
    ...
    tagToClass() {
        return reactMappings[this.tag] || 'div';
    }
...
class JSXBEMComponentNode extends JSXComponentNode {
    constructor(args) {
        super(args);
...
class JSXBEMSimpleComponentNode extends JSXBEMComponentNode {
    ...
    toString() {
        this.props = Object.assign({}, this.bemEntity.valueOf(), this.props);
        return super.toString();
    }
}
